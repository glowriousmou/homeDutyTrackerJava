...
public class DatabaseSetupTest {
    private static final Logger logger = Logger.getLogger(DatabaseSetupTest.class);
    public static void createDatabaseIfNotExists() {

        try (InputStream input = DatabaseSetupTest.class.getClassLoader().getResourceAsStream("db/test-db.properties")) {
