...
public class DatabaseSetupTestGlobal {
    private static final Logger logger = Logger.getLogger(DatabaseSetupTestGlobal.class);
    public static void createDatabaseIfNotExists() {

        try (InputStream input = DatabaseSetupTestGlobal.class.getClassLoader().getResourceAsStream("db-test-global/test-db-global.properties")) {
